...
window.switchIdentityTab = function (tabName) {
  ...
  if (tabName === 'skills' || tabName === 'certs') {
...
const projectData = {
  ...
  3: {
    ...
    github: "https://github.com/sohee9010/rhythm-game-website",
    demo: "https://rhythm-game-frontend-ph63.onrender.com/",
  ...
  filteredProjectIds.forEach((id, index) => {
    ...
    card.innerHTML = `
      ...
      <div class="project-info-overlay">
        ...
        <div class="click-to-view-cta"><i class="fas fa-arrow-right"></i> Click to view details</div>
      </div>
    `;
